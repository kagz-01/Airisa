      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
        <div>
          <div class="flex items-center gap-2 font-semibold">
            <img src="/images/AGC.png" alt="Airisa Green" class="h-6 w-6" />
        ...
        <div>
          ...
          <ul class="space-y-1 text-sm">
            <li>
              <a class="text-emerald-100 hover:text-white transition-colors" href="/about">About</a>
            </li>
            <li>
              <a class="text-emerald-100 hover:text-white transition-colors" href="/services">Services</a>
            </li>
            <li>
              <a class="text-emerald-100 hover:text-white transition-colors" href="/industries">
                Industries
              </a>
            </li>
            <li>
              <a class="text-emerald-100 hover:text-white transition-colors" href="/contact">Contact</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="space-y-1 text-sm">
            ...
            <li>
              <a class="text-emerald-100 hover:text-white transition-colors" href="/ecard">E‑Card</a>
            </li>
          </ul>
        </div>
      </div>
