...
export default function Hero() {
  return (
    <section class="relative overflow-hidden py-24 md:py-32 min-h-[75vh] flex items-center">
      ...
      <div class="absolute -bottom-24 -left-24 w-96 h-96 bg-amber-400/10 rounded-full blur-[100px] pointer-events-none z-0 animate-pulse" />
      ...
      <div class="container mx-auto px-6 relative z-10">
        <h1 class="text-5xl md:text-7xl font-black leading-[1.1] text-white drop-shadow-2xl tracking-tighter animate-fade-in-up">
          Transforming <span class="text-amber-400">Mobility</span>{" "}
          and Environmental Sustainability in Africa
        </h1>

        <div class="mt-8 max-w-2xl relative">
          {/* Disruptor vertical line */}
          <div class="absolute -left-6 top-0 bottom-0 w-1 bg-gradient-to-b from-amber-400 to-transparent rounded-full hidden md:block" />
          ...
          >
            <a
              href="/services"
              class="px-8 py-4 bg-amber-400 hover:bg-amber-500 text-emerald-950 font-bold rounded-tr-2xl rounded-bl-2xl rounded-tl-md rounded-br-md transition-all transform hover:scale-105 shadow-xl"
            >
              Our Services
            </a>
            <a
