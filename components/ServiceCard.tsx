...
export default function ServiceCard(props: ServiceCardProps) {
  ...
  return (
    <div class="group border border-emerald-100/50 dark:border-emerald-800/40 rounded-tr-[40px] rounded-bl-[40px] rounded-tl-xl rounded-br-xl overflow-hidden bg-white dark:bg-emerald-900/10 hover:shadow-[0_20px_50px_rgba(5,150,105,0.15)] dark:hover:shadow-emerald-900/20 transition-all duration-500 hover:border-emerald-200/60 dark:hover:border-emerald-700/50 flex flex-col h-full relative">
      {/* Decorative Fragment */}
      <div class="absolute -top-4 -right-4 w-12 h-12 bg-amber-400/10 rounded-full blur-2xl group-hover:bg-amber-400/20 transition-all duration-500" />
      ...
      {props.image
        ? (
          <div class="h-56 overflow-hidden relative">
            ...
            <div class="absolute bottom-4 left-6">
              <div class="w-8 h-1 bg-amber-400 mb-2 transform origin-left group-hover:scale-x-150 transition-transform duration-500" />
        ...
        : (
          <div class="p-6 pb-0">
            <div class="w-14 h-14 rounded-tr-2xl rounded-bl-2xl rounded-tl-md rounded-br-md bg-emerald-50 dark:bg-emerald-900/40 flex items-center justify-center text-emerald-600 dark:text-emerald-400 mb-6 group-hover:bg-amber-400 dark:group-hover:bg-amber-500 group-hover:text-emerald-950 transition-all duration-500 transform group-hover:rotate-6">
      ...
      <div class="p-6 pt-4 flex-1 flex flex-col">
        ...
        <div class="mt-6 pt-5 border-t border-emerald-50/50 dark:border-emerald-800/40">
          ...
          >
            ...
            <span class="text-amber-500 dark:text-amber-400 group-hover:translate-x-1 transition-transform">
              →
            </span>
          </a>
        </div>
