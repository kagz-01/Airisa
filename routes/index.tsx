  ...
  return (
    <>
      ...
      <section class="py-16 md:py-20 bg-white dark:bg-emerald-950 relative overflow-hidden transition-colors duration-500">
        ...
        <div
          class="absolute bottom-0 left-0 w-64 h-64 bg-lime-50/50 dark:bg-lime-900/10 rounded-full translate-y-1/2 -translate-x-1/2 blur-3xl opacity-40 animate-pulse transition-colors"
          style={{ animationDelay: "1.5s" }}
        />

        <div class="container mx-auto px-6 relative z-10">
          <div class="max-w-3xl mb-10">
            <h2 class="text-3xl md:text-5xl font-black text-emerald-950 dark:text-emerald-50 tracking-tighter">
          ...
          <div class="relative flex flex-col gap-8 md:gap-0">
            {/* Pillar 1: Insight */}
            <div class="md:w-[45%] bg-white dark:bg-emerald-900/20 rounded-tr-[40px] rounded-bl-[40px] p-6 md:p-8 shadow-[0_30px_60px_-15px_rgba(5,150,105,0.08)] border border-emerald-50 dark:border-emerald-800/30 relative z-10 transition-all duration-500 hover:scale-[1.03] hover:shadow-[0_45px_100px_-20px_rgba(5,150,105,0.15)] group animate-fade-in-up">
              <div class="flex items-center gap-4 mb-4">
                <span class="text-4xl group-hover:animate-bounce-slow">🧭</span>
              </div>
              <h3 class="text-4xl md:text-5xl font-black text-emerald-950 dark:text-emerald-50 mb-6 leading-none tracking-tighter drop-shadow-sm group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">
                Insight
              </h3>
              <p class="text-lg text-slate-600 dark:text-emerald-50/60 leading-relaxed font-medium">
            ...
            <div
              class="md:w-[45%] md:ml-auto md:-mt-10 bg-emerald-950 rounded-tl-[40px] rounded-br-[40px] p-6 md:p-8 shadow-2xl relative z-20 transition-all duration-500 hover:scale-[1.03] hover:-translate-y-2 animate-fade-in-up group"
              style={{ animationDelay: "200ms" }}
            >
              <div class="flex items-center gap-4 mb-4">
                <span class="text-3xl text-lime-400 group-hover:scale-125 transition-transform duration-500">
                  ⚡
                </span>
              </div>
              <h3 class="text-4xl md:text-5xl font-black text-white mb-6 leading-none tracking-tighter group-hover:text-lime-400 transition-colors">
                Strategy
              </h3>
            ...
            <div
              class="md:w-[45%] md:-mt-10 bg-white dark:bg-emerald-900/20 rounded-tr-[40px] rounded-bl-[40px] p-6 md:p-8 shadow-[0_30px_60px_-15px_rgba(5,150,105,0.08)] border border-emerald-50 dark:border-emerald-800/30 relative z-10 transition-all duration-500 hover:scale-[1.03] animate-fade-in-up group"
              style={{ animationDelay: "400ms" }}
            >
              <div class="flex items-center gap-4 mb-4">
                <span class="text-3xl text-emerald-600 group-hover:rotate-12 transition-transform duration-500">
                  🌍
                </span>
              </div>
              <h3 class="text-4xl md:text-5xl font-black text-emerald-950 dark:text-emerald-50 mb-6 leading-none tracking-tighter group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">
                Sustainability
              </h3>
              <p class="text-lg text-slate-600 dark:text-emerald-50/60 leading-relaxed font-medium">
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {services.slice(0, 4).map((s, _i) => (
              <div class="group p-6 bg-paper dark:bg-emerald-900/20 border border-emerald-50 dark:border-emerald-800/30 organic-radius hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                <div class="w-10 h-1 bg-lime-400 mb-4 group-hover:w-full transition-all duration-500" />
                <h4 class="text-lg font-bold text-emerald-950 dark:text-emerald-50 mb-2">
                  {s.title}
                </h4>
                <p class="text-slate-600 dark:text-emerald-50/60 text-sm leading-relaxed opacity-80">
                  {s.desc}
                </p>
              </div>
            ))}
      ...
      <section class="py-16 md:py-24 bg-emerald-950 relative overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-lime-400 to-transparent opacity-30" />
        ...
        <div class="container mx-auto px-6 relative z-10">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            {namedPrograms.slice(0, 3).map((p, _i) => (
              ...
              >
                <div class="text-[10px] font-black uppercase tracking-widest text-lime-400 mb-3 opacity-70">
                  {p.pillar}
                </div>
                <h4 class="text-xl font-bold text-white mb-3 group-hover:text-lime-400 transition-colors">
                  {p.title}
                </h4>
