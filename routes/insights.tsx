...
const articles: Item[] = [
  {
    ...
    summary: "How multi-source mobility datasets surface accessibility and safety gaps for informal transit users.",
    pillar: "Insight",
    href: "#"
  },
  {
    title: "Designing Inclusive E-Mobility Programs",
    summary: "Principles for integrating gender-responsive and disability-inclusive perspectives into charging and fleet pilots.",
    pillar: "Strategy",
    href: "#"
  },
  {
    title: "Operationalizing Sustainability in Last-Mile Logistics",
    summary: "Embedding lifecycle thinking, emissions tracking, and circular inputs in emerging urban delivery models.",
...
const researchSnapshots: Item[] = [
  {
    ...
    summary: "Structured approach to early-stage program scoping: context, actors, enabling policy, data maturity.",
    pillar: "Insight"
  },
  {
    title: "Risk & Safeguards Matrix",
    summary: "Mapping environmental and social vectors to mitigation pathways across transport interventions.",
    pillar: "Sustainability"
  },
  {
    title: "Adaptive Implementation Ladder",
    summary: "Iterative milestone structure aligning feasibility, stakeholder alignment, and sustainability integration.",
    pillar: "Strategy"
  }
];
...
const methodologies: Item[] = [
  {
    ...
    summary: "Combining surveys, sensor feeds, open standards, and participatory mapping for richer transit intelligence.",
    pillar: "Insight"
  },
  {
    title: "Inclusive Consultation Protocol",
    summary: "Sequenced engagement ensuring marginalized commuter voices inform design pivots early.",
    pillar: "Strategy"
  },
  {
    title: "Sustainability Integration Checklist",
    summary: "Lifecycle, circularity, carbon, and equity checkpoints embedded pre- and post-deployment.",
    pillar: "Sustainability"
  }
];
    ...
    <div class="container mx-auto px-6 py-12">
      ...
      <div class="max-w-3xl">
        ...
        <p class="mt-4 text-slate-600 leading-relaxed">
          Evidence, frameworks, and applied learning powering impact across our consulting and program portfolio. We translate multi-source data and on-the-ground practice into actionable guidance.
        </p>
      ...
      <section class="mt-12">
        ...
        <p class="mt-2 text-sm text-slate-600 max-w-2xl">
          Concise analytical artifacts and structural tools guiding diagnostics, safeguards, and adaptive delivery.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
          {researchSnapshots.map((r) => <Card item={r} />)}
        </div>
      </section>
      ...
      <section class="mt-12">
        ...
        <p class="mt-2 text-sm text-slate-600 max-w-2xl">
          Reusable scaffolds shaping inclusive, data-driven and sustainability-aligned program design.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
          {methodologies.map((m) => <Card item={m} />)}
        </div>
      </section>
      ...
      <div class="mt-14 bg-emerald-50 border border-emerald-100 rounded-xl p-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div class="text-sm text-slate-700">
          Want to apply these insights in a live initiative? Partner with us to co-design evidence-led, sustainable mobility solutions.
        </div>
        <div class="flex gap-3">
          <a href="/services" class="px-4 py-2 rounded-md bg-white border border-emerald-300 text-emerald-700 hover:bg-emerald-100 text-sm font-medium">Explore Services</a>
