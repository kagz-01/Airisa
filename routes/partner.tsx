...
export default function Partner() {
  return (
    <div class="bg-paper min-h-screen relative overflow-hidden">
      ...
      <div className="absolute bottom-[-5%] left-[-10%] w-[30%] h-[50%] bg-lime-50 organic-radius -rotate-6 -z-10 opacity-40">
      </div>
      ...
      <div class="container mx-auto px-6 py-12 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-12">
          <div class="lg:col-span-8">
            ...
            <div class="h-1.5 w-40 bg-lime-400 mt-6 animate-glow-emerald">
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div class="lg:col-span-8 lg:col-start-1 animate-fade-in-up">
            <div class="bg-white dark:bg-emerald-900/20 organic-radius p-6 md:p-10 shadow-2xl relative border border-emerald-100 dark:border-emerald-800/40 overflow-hidden transition-colors">
              ...
              <div class="relative z-10">
                <h2 class="text-2xl font-bold text-emerald-900 dark:text-emerald-100 mb-8 border-l-4 border-lime-400 dark:border-lime-500 pl-4 transition-colors">
          ...
          <div class="lg:col-span-4 space-y-8 animate-fade-in-up delay-200">
            <div class="bg-emerald-900 text-white p-6 organic-radius shadow-xl">
              <h3 class="text-xl font-bold mb-4 text-lime-400">
                Direct Channels
              </h3>
              <ul class="space-y-6 text-sm">
                ...
                <li class="flex flex-col gap-1 text-emerald-50">
                  ...
                  <a
                    ...
                    class="hover:text-lime-400 transition break-all underline decoration-emerald-700 decoration-2 underline-offset-4"
                  >
                ...
                <li class="flex flex-col gap-1">
                  ...
                  <a
                    ...
                    class="hover:text-lime-400 transition underline decoration-emerald-700 decoration-2 underline-offset-4"
                  >
                    +254 738573190
                  </a>
                </li>
            ...
            <div class="bg-white/50 dark:bg-emerald-900/20 backdrop-blur-md p-8 border border-emerald-100/50 dark:border-emerald-800/30 rounded-[2px] shadow-lg transition-colors">
              ...
              <div class="mt-4">
                <a
                  href="/ecard"
                  class="text-xs font-bold text-emerald-700 dark:text-emerald-400 border-b-2 border-lime-400 pb-0.5 hover:text-emerald-900 dark:hover:text-emerald-200 transition"
                >
                  Download E‑Card (VCF) →
                </a>
              </div>
